    ...
    try {
        ...
        await prisma.activityLog.create({
            data: {
                ...
                entityType: 'user',
                entityId: userId,
                metadata: { name, email, role, permissions: permissions },
            },
        });
        res.status(201).json({
            id: userId,
