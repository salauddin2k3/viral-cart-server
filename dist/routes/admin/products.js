...
router.patch('/:id', async (req, res, next) => {
    try {
        ...
        if (parsed.shortDescription !== undefined)
            updateData.shortDescription = parsed.shortDescription;
        if (parsed.fullDescription !== undefined)
            updateData.fullDescription = parsed.fullDescription;
        ...
        if (parsed.trackInventory !== undefined)
            updateData.trackInventory = parsed.trackInventory;
        if (parsed.lowStockThreshold !== undefined)
            updateData.lowStockThreshold = parsed.lowStockThreshold;
        if (parsed.featuredFlag !== undefined)
            updateData.featuredFlag = parsed.featuredFlag;
        if (parsed.bestSellerRank !== undefined)
            updateData.bestSellerRank = parsed.bestSellerRank;
